...
<section>
    ...
    <div class="bg-white p-14">
        ...
        <p class="text-2xl ml-9 leading-loose mb-16">
        ...
        <h2 class="text-4xl mb-10">3.書籍の編集について</h2>
        <p class="text-2xl ml-9 leading-loose mb-16">
         ヘッダーにある書籍詳細を押下し、書籍詳細ページへと遷移します<br>
         編集したい書籍の「編集」ボタンを押下していただくと登録内容を修正、編集していただけます。
    
        </p>

        <h2 class="text-4xl mb-10">4.書籍の削除について</h2>
        <p class="text-2xl ml-9 leading-loose mb-16">
         こんなところまで読んだあなたは天才！シンリンカムイマスター！
        </p>
    </div>
</section>
