   ...
   <section>
    <h2 class="text_heading mb-11 text-3xl font-semibold">登録書籍一覧</h2>
        <ul class="flex border-b mb-20">
            <li class="-mb-px mr-1">
                <a class="text_brown_paper  inline-block border-l border-t border-r rounded-t py-2 px-4  font-semibold underline" href="{{ url('/booklist_paper') }}">紙媒体</a>
            </li>
            <li class="mr-1">
                <a class="text_brown_date inline-block py-2 px-4 font-semibold" href="{{ url('/booklist_date') }}">電子書籍</a>
            </li>
        </ul>
    </section>
    ...
    <section>
        <div class="grid grid-cols-4 gap-16">
            ...
            <div class="px-6 py-4">
                <div class="font-bold text-xl mb-2">僕のヒーロアカデミア1</div>
